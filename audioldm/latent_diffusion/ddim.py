...
class DDIMSampler(object):
    ...
    def sample(
        ...
        **kwargs,
        ...
        self.make_schedule(ddim_num_steps=S, ddim_eta=eta, verbose=verbose) # 计算diffusion中用到的所有alpha，beta，和各种计算之后的值，用到了加快采样的方法，原始
        # sampling                                                            Diffusion步长是1000步，这里的传入200，所以每步的alpha和beta就是之前1000步中隔5个抽一个
        C, H, W = shape
    ...
    def p_sample_ddim(
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.0:
            ...
            e_t_uncond, e_t = self.model.apply_model(x_in, t_in, c_in).chunk(2)     # 得到两个采样噪声
            ...
            e_t = e_t_uncond + unconditional_guidance_scale * (e_t - e_t_uncond)    # 论文中Classifier-free guidance 里提到的参数 w
